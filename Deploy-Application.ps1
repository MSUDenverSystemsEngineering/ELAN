...
Try {
	...
	[string]$appVendor = ''
	[string]$appName = 'ELAN'
	[string]$appVersion = '6.4'
	[string]$appArch = 'X64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '09/01/2022'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Show-InstallationWelcome -CloseApps 'ELAN' -CheckDiskSpace -PersistPrompt
		...
		Execute-Process -Path $dirFiles\ELAN_6-4_win.exe -Parameters "/VERYSILENT /ALLUSERS /NORESTART"
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'ELAN' -CloseAppsCountdown 60
		...
		Execute-Process -Path $envProgramFiles\ELAN_6.4\unins000.exe -Parameters "/VERYSILENT /NORESTART"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAunqwScJXhjBiR
# rlNw0+ANhtkSPKpzbK5ON24Lw1dVe6CCH8EwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# AYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgPdKhoXXR7O2X
# 4i6uU5eEtgQPE1Ks2s1rkHSYIpWyJOQwDQYJKoZIhvcNAQEBBQAEggGAbNDXDgI/
# xyxtSmRY5yqSKzuDh0GPL32Cd9tgMuyBtl4kzHCjIRbvPS7IUdkzioo8zE+xovBe
# qdva+H67R9ygv0J1Us6byhmpC6TnW8q2a0Sv3bUZ8c46lkcEmsBICyVkvcorhvdG
# KR/dTnJ3gUzOKIf4zYw2uz6lTGxK5d5REqWpDQ3wiVnGfj7tf5PfXna2m8jkLhlr
# RcDk+OSGrLVf0zOBL+8tz0YtEi+njm0jFiIxYtlmDoUc+Q6JqTzkgfM7mCPxE/FQ
# wab+cU6hYwJgc+DaupD9if0AGoZnac4YC9gMUanZ4cf+JtH0o2C5IVHPYBXLvY9j
# 3c0p16XOFHhkDy9dFc8MMnZ7K94LyXpM+ypEQqFKjY9+peXVNLYG2tkX4F0Mv6l9
# tTyyIf9lhIxLpv/mkBdEGe2fZFHW6Z854qTQuTzqpDtxc63pc485uCSMKIK5WyDj
# Zh64MK1ac4vt54PEsRneUfkhCujEX0TttFqYUijTMRO2YT+o+43QjN82oYIDTDCC
...
# BgkqhkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMjA5MDEx
# NjIwMTVaMD8GCSqGSIb3DQEJBDEyBDDCfnvOdx272e0zT5LN8rhf+VRhrIfDpVuS
# mnMRJ+3mD0lBU0zQ2IV0hl14uZkn6kQwDQYJKoZIhvcNAQEBBQAEggIAIMY5guFA
# M+pcBeaBb601egCMK67m8P0m5gtaGkb09aH3HISlYwh5Hl4YFAHhy5M33ObP7XjT
# 29xHjUmCDF0XSmcZ9xbdLlbRqjek0XyHyp5ApF2wdfw0wguA/pZfE2aDteT+mZue
# q7DlVUkKJ9yORRUr9MxZp1T2wTaWGrvXXfjtLMVLE7daDPxEv5xV3VNfEd87Q08b
# NJZGRdXlZptFdULiRFoHcoHI9lVdxp+UcPn7oXYSKM5MIvjS1VB4lKPxrx7rn1yB
# jSvXfEQcQloNVd4ePrQxNQI9Vsz/Ooy8Jr/rzbNVTCuQlfp/KIu9PkcPeDxW+bMU
# oKoacG2/kzjOKgjtYfj4xmibmFedvl6BsYyKjyx4WMHaY2kmAfrF+dOXyyEnR9Z7
# 0D0S3JLbFCTHLakQUfmzrSyZjGYeC+nv3NFPi5tvP7v2ZF5tQuBJ/bGbzvKmkinw
# K3niCC/W+q+J/EcOdSpuCPIelRaK/4T0WQDp9al41gMF8LT1h/O16wYx5q9OfFjx
# 52dKtUxf9d9HNGGlsEy2ABQ/3VoTvD64uOjnEbralxgco+5wSMd8RhFvXvGHoFsY
# X/HNhoqfp0O0/7fMt54pRYPdjqfXt4UhYt9d1JS5nDRUipG+B6ffjcn4jDzHNhrC
# Op21P0hI+vC2Vk/fmyr29bEopQ4ji4VV3rk=
